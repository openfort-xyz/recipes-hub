...
export function ActionPanel({ userAddress, selected }: { userAddress: string; selected: VaultOption }) {
    ...
    >
      <div className="flex items-center gap-3">
        <div className="relative flex-1">
          ...
          />
          <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-neutral-500">USDC</span>
        </div>
        <button
