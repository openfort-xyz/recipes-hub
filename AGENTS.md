...
## Project overview
- Collection of Openfort integration samples (`7702`, `aave`, `agent-permissions`, `bridge-offramp`, `hyperliquid`, `lifi`, `morpho`, `mpp`, `near-intents`, `telegram-bot`, `usdc`, `vaults-fyi`, `x402`).
