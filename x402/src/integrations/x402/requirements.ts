...
export function ensureValidAmount(paymentRequirements: PaymentRequirements): PaymentRequirements {
  const updated: PaymentRequirements = JSON.parse(JSON.stringify(paymentRequirements));
...
function sortByNetworkPriority(requirements: PaymentRequirements[]): PaymentRequirements[] {
...
function fallbackRequirement(requirements: PaymentRequirements[]): PaymentRequirements {
