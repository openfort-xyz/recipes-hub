...
export function getRequiredAmount(paymentRequirements: PaymentRequirements): bigint {
  return BigInt(paymentRequirements.maxAmountRequired);
}

export function hasSufficientBalance(balance: bigint, requiredAmount: bigint): boolean {
