...
| [gnosis-pay](./gnosis-pay/) | Self-custodial Gnosis Pay account ownership, Safe deployment, Roles + Delay (Zodiac) modules, spending allowances, EIP-712 signing via embedded EOA, EURe funding on Gnosis Chain | Expo React Native, account-kit, Ethers.js |
