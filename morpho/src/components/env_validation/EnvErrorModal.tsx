          ...
          <div className="flex items-start">
            ...
            <div className="flex-1">
              ...
              <ol className="text-neutral-300 space-y-1 text-sm list-decimal list-inside">
                <li>
                  Create or update your <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-xs">.env</code> file
                </li>
                <li>
                  Copy values from <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-xs">.env.example</code>
                </li>
