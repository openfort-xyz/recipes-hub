...
const _defaultChainId = Number.parseInt(process.env.NEXT_PUBLIC_OPENFORT_DEFAULT_CHAIN_ID ?? '84532', 10)
...
const UI_CONFIG = {
  ...
  // Embedded wallet only — see the note in config/wagmi-config.ts.
...
export const OpenfortProviderBoundary = ({ children, debugMode = true }: OpenfortProviderBoundaryProps) => {
  return (
    <OpenfortProvider
      debugMode={debugMode}
