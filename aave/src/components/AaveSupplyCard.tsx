      ...
      <div className="text-center">
        {isConnected && address ? (
          <div className="space-y-3">
            <div className="text-xs text-neutral-400 uppercase tracking-wider">Aave Supply</div>
            ...
            {!suppliesLoading && usdcSupplyData.apy !== '0.00' && (
              <div className="text-sm text-green-400 font-semibold">🌱 {usdcSupplyData.apy}% APY</div>
            )}
            {suppliesError && <div className="text-xs text-red-400">Failed to load</div>}
          </div>
        ) : (
