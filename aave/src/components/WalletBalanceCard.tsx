      ...
      <div className="text-center">
        {isConnected && address ? (
          <div className="space-y-3">
            <div className="text-xs text-neutral-400 uppercase tracking-wider">Wallet Balance</div>
            <div className="text-4xl font-bold text-white">{formatUsdcBalance(usdcBalance as bigint | undefined)}</div>
