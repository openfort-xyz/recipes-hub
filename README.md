...
| **[Native staking with Yield.xyz](./yield-xyz/)**               | Native MON staking on Monad via Yield.xyz's StakeKit API. Discover, enter, track, and exit a staking position, entirely non-custodial.              | `pnpx gitpick openfort-xyz/recipes-hub/tree/main/yield-xyz openfort-yield-xyz && cd openfort-yield-xyz`       |
...
| **Yield.xyz**           | React + Vite | Express.js | Monad Testnet     | `wagmi`, `viem`                                      |
