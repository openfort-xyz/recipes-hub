...
| **[Cash out with Bridge](./bridge-offramp/)**                 | Move USDC out of an embedded wallet to a real bank account through Bridge (Stripe). Hosted KYC, a linked US or SEPA account, and a liquidation address that converts and pays out every deposit. | `pnpx gitpick openfort-xyz/recipes-hub/tree/main/bridge-offramp openfort-bridge-offramp && cd openfort-bridge-offramp` |
